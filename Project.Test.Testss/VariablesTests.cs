...

{
    public class VariablesTests
    {
        ...
        [TestCase(1, 1)] //negativTest1
        public void SolveFormula_WhenAIsEqualB_SholdThrowArgumentException(int a, int b)
        {
        ...
        [TestCase(0,2,1)] //negativTest2
        public void SolveTheEquatio_WhenAIsEqualZero_SholdThrowArgumentException(int a, int b,int c)
        {
            Assert.Throws<ArgumentException>(() => Variables.SolveTheEquation(a, b,c));
        }

        [TestCase(1, 2, 3, 4, "y = 1x + 1")] //positivTest3
        ...
        [TestCase(2, 1, 2, 3)] //negativTest3

        public void GetEquationOfStraightLine_WhenX1IsEqualX2_SholdThrowArgumentException(int x1, int y1, int x2, int y2)
        {
